...
BARCODE_DIR=${BASE}/Diet_GLP_scMultiome_Scripts/gex_filtered_pre_EA/barcodes
ATLAS=/Genomics/pritykinlab/seth/ATACCompendium/results/all_atac_peaks.bed
TSS_BED=${BASE}/mm10_tss.bed
OUT_DIR=${BASE}/Diet_GLP_scMultiome_Scripts/atac_filtered
SCRIPT=${BASE}/Diet_GLP_scMultiome_Scripts/02_atac_import.py
